                                                                ...
                                                                <table class="table table-hover  dataTable" id="sample_5" role="grid" >
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="ft-16"><b>{{$customer->id}}</b>
                                                                            </td>
                                                                            <td class="ft-16">{{isset($customer->name)?$customer->name:''}}
                                                                            </td>
                                                                            <td class="ft-16">{{isset($customer->email)?$customer->email:''}}</td>
                                                                            <td class="ft-16">{{isset($customer->customer->phone)?$customer->customer->phone:''}}
                                                                            </td>
                                                                            <td class="ft-16">
                                                                                {{isset($customer->customer->address)?$customer->customer->address:''}}</td>
                                                                                <td class="ft-16">
                                                                                    ...
                                                                                    <td class="ft-16">
                                                                                        {{isset($customer->customer->region_classification)?$customer->customer->region_classification:''}}
                                                                                    </td>
                                                                                    <td class="ft-16"><b> {{isset($customer->customer->partner_classification)?ucfirst($customer->customer->partner_classification):''}}</b>
                                                                                    </td>
                                                                                    <td class="ft-16"> 
                                                                                    ...
                                                                                    <td class="ft-16"> {{isset($customer->createdBy->name)?ucfirst($customer->createdBy->name):''}}
                                                                                    </td>
                                                                                    <td class="ft-16">
