                                                    ...
                                                    <div class="table Add">
                                                           ...
                                                           <table class="collapse in table table-hover  order-column dataTable" id="sample_5" role="grid" aria-describedby="sample_5_info">
                                                            <thead>
                                                                <tr class="secondary_bg font-white">
                                                                   ...
                                                                   <th style="width:20%;">Blog name
                                                                   </th>


                                                                   <th style="width:20%;">Blog header
                                                                   </th>
                                                                   <th style="width:20%;">Launch date
                                                                   </th>
                                                                   <th style="width:20%;">Campaign message</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr data-toggle="collapse" class="" data-target="#sample_5">
                                                                <td class="ft-16"><b> {{$blog->id}}</b>
                                                                </td>
                                                                <td class="ft-16">{{isset($blog->name)?$blog->name:''}}</td>
                                                                <td class="ft-16">{{isset($blog->header)?$blog->header:''}}</td>
                                                                 <td class="ft-16">{{isset($blog->launch_date)?$blog->launch_date:''}}</td>
                                                                <td class="ft-16">
                                                                ...
                                                                <td>
                                                                    <a href="{{route('admin.blog.delete',$blog->id)}}"> <span class="glyphicon glyphicon-trash"></span></a></td>
                                                                </tr>
                                                                @endforeach
                                                            </tbody>
                                                        </table>
