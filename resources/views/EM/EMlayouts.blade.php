                ...
                <ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 6px">
                    ...
                    <li class="nav-item  secondary_bg font-white">
                        <a href="#" class="nav-link nav-toggle">
                            ...
                            <span class="title head">Decarbonization 
                            initiatives</span>
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu new1">
                            <li class="nav-item  ">
                                <a href="{{ url('em/decarboproject') }}" class="nav-link ">
                                    <span class="title">Project dev
                                        launcher
                                    </span>
                                </a>
                            </li>
                            <li class="nav-item  ">
                                <a href="{{ url('em/decarbo') }}" class="nav-link ">
                                    <span class="title">Emission request
                                    </span>
                                </a>
                            </li>
                        </ul>
