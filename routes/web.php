...
Route::group(['middleware'=>'protectAdmin'],function(){
	Route::group(['prefix'=>'admin/'],function(){
		...
		Route::get('/dashboard',[AdminController::class,'transections']);
	...
	// Route::get('/delete/blog/{id}',[AdminController::class,'delete_blog'])->name('admin.blog.delete');
		...
		Route::get('/transections',[AdminController::class,'transections'])->name('admin.transections');
	});
});
// <-----END ADMIN----->
...
//    <-----EM ROUTE----->
Route::group(['middleware'=>'protectEM'],function(){
	Route::group(['prefix'=>'em/'],function(){
		// Route::get('/dashboard',[EMController::class,'dashboard' ])->name('em.dashboard');
		Route::get('/dashboard',[EMController::class,'decarboproject' ])->name('em.dashboard');
...
//  <----HR ROUTE----->
Route::group(['middleware'=>'protectHR'],function(){
	// Route::get('HR/dashboard',[HRController::class, 'dashboard']);
	Route::get('HR/dashboard',[HRController::class, 'faq']);
...
// <-----Employee ROUTE---->
Route::group(['middleware'=>'protectEmployee'],function(){
	...
	Route::group(['prefix'=>'employee/'],function(){
		...
		Route::get('investment/{id}',[EmployeeController::class,'investment'])->name('employee.investment');
...
Auth::routes();
Route::post('/register',[RegisterController::class,'index'])->name('user.register');
